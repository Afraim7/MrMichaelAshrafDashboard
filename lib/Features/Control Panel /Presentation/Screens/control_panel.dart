      ...
      body: BlocConsumer<AdminFunctionsCubit, AdminFunctionsState>(
        ...
        builder: (context, state) {
          ...
          return RefreshIndicator(
            // Match brand palette for the refresh spinner background.
            backgroundColor: AppColors.cardDark,
            // Spinner color aligns with midblue accent.
            color: AppColors.midBlue,
            // Pull-to-refresh fetches every dashboard section again.
            onRefresh: () {
                ...
                children: [
                  ...
                  LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      if (state is AdminLoadingExams && _exams.isEmpty) {
                        return Padding(
                          padding: const EdgeInsets.all(20),
                          child: Center(child: DashboardHelper.appCircularInd),
                        );
                  ...
                  LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      if (state is AdminLoadingHighlights &&
                          _highlights.isEmpty) {
                        return Padding(
                          padding: const EdgeInsets.all(20),
                          child: Center(child: DashboardHelper.appCircularInd),
