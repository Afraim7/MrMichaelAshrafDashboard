...
class _HighlightsCenterState extends State<HighlightsCenter> {
  ...
  // Memoized refresh future so repeated pulls wait for the same fetch.
      ...
      body: BlocConsumer<AdminFunctionsCubit, AdminFunctionsState>(
        ...
        builder: (context, state) {
          ...
          return RefreshIndicator(
            // Dark surface keeps the pull-to-refresh overlay subtle.
            backgroundColor: AppColors.cardDark,
            // Midblue indicator mirrors the rest of the dashboard spinners.
            color: AppColors.midBlue,
            // Refreshes highlights based on the currently selected grade filter.
            onRefresh: () {
