...
import 'package:mrmichaelashrafdashboard/Shared/Models/exam_result.dart';
...
class _ExamResultTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (percentage < 50) {
      // RED
      tileColor = AppColors.tomatoRed.withOpacity(0.1);
      textColor = AppColors.tomatoRed;
      iconColor = AppColors.tomatoRed;
      icon = Icons.cancel;
    } else if (percentage < 75) {
      // YELLOW
      tileColor = AppColors.royalYellow.withOpacity(0.1);
      textColor = AppColors.royalYellow;
      iconColor = AppColors.royalYellow;
      icon = Icons.error;
    } else {
      // GREEN
      tileColor = AppColors.lightGreen.withOpacity(0.1);
