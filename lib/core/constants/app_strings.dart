...
class _Errors {
  ...
  // ── Connectivity / permission ── shared messages used by the central
  //    Firebase error translator. Strings live here so they stay localizable
  //    in one place across every cubit and screen.
  final String noInternet =
      'تعذّر الاتصال بالإنترنت. تحقّق من اتصالك وحاول مرة أخرى.';
  final String requestTimeout =
      'انتهت مهلة الاتصال. السيرفر بطيء أو غير متاح حالياً، حاول لاحقاً.';
  final String serviceUnavailable =
      'الخدمة غير متاحة مؤقتاً. حاول مرة أخرى بعد قليل.';
  final String permissionDenied =
      'ليس لديك صلاحية للقيام بهذا الإجراء. تواصل مع المسؤول للحصول على الصلاحيات.';
  final String notAuthenticated =
      'انتهت جلستك. يرجى تسجيل الدخول مرة أخرى للمتابعة.';
  final String notFoundResource = 'العنصر المطلوب غير موجود أو تم حذفه.';
...
class _EmptyStates {
  ...
  final String noUsers = 'لا يوجد طلاب مسجلين حالياً';
  final String noUsersForGrade = 'لا يوجد طلاب للصف المحدد';
}
